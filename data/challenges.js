...
MI.data.challenges = [
  ...
  { id: 'nft-cromos-tebeo', title: 'Marketplace de cromos con humo digital', situation: 'Un cliente quiere un mercado de cromos coleccionables de sus personajes de tebeo favoritos. Contrato inteligente, subastas, regalías al autor y una tienda que no dé vergüenza. El presupuesto llegó antes que el diseñador.', tech: 'evm', difficulty: 3, skills: { blockchain: 3, web3: 2, front: 2, design: 1 }, twist: { text: 'Nadie ha traído arte. Si el equipo no dibuja decentemente, los cromos salen churros y el cliente los ve antes de firmar.', skills: { design: 3, ux: 1 }, tech: null }, tags: ['desarrollo', 'chain', 'negocio'] },
