...
MI.data.challenges = [
  ...
  },
  {
    ...
    skills: { security: 2, sysadmin: 1, back: 1 },
  ...
  { id: 'seo-collapse', title: 'La web ha desaparecido de Google', situation: 'Tras el rediseño, el tráfico orgánico ha caído un 95 %. Alguien dejó un "noindex" en la plantilla base "para que no lo viera nadie durante las pruebas".', tech: 'wordpress', difficulty: 2, skills: { performance: 2, front: 2, management: 1 }, twist: null, tags: ['incidente', 'negocio'] },
  { id: 'drupal-security-update', title: 'Actualizar un Drupal 7 abandonado antes de que lo actualicen otros', situation: 'Drupal 7 está fuera de soporte y hay un exploit público. La web tiene 14 módulos personalizados sin documentación y un tema que rompe si respiras.', tech: 'php', difficulty: 3, skills: { legacy: 2, security: 2, back: 1 }, twist: null, tags: ['migracion', 'seguridad'] }
];
