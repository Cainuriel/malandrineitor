...
MI.data.challenges = [
  ...
  { id: 'token-clean-sin-integrar', title: 'El token se presenta el jueves y no hay nada conectado', situation: 'Sercampo presenta su token Clean dentro de una semana. El contrato está desplegado y las APIs tienen cuatro mil endpoints, pero la aplicación no llama a ninguno: en el equipo de front nadie ha integrado una cartera antes. No falta protocolo, falta pegamento.', tech: 'evm', difficulty: 4, skills: { web3: 4, front: 2, apis: 2, blockchain: 1 }, twist: { text: 'Para que el usuario no pague gas se montó un paymaster que subvenciona las transacciones. Nadie lo ha fondeado, así que todas revierten sin compasión.', skills: { blockchain: 2, observability: 2 }, tech: null }, tags: ['desarrollo', 'chain', 'incidente', 'negocio'] },
